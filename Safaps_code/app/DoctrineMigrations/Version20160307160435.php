 ...
 */
class Version20160307160435 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD totalCost NUMERIC(10, 0) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE invoice DROP totalCost');
    }
}
